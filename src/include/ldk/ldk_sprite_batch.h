...
namespace ldk
{
  namespace renderer
  {
    ...
    LDK_API void spriteBatch_draw(const Sprite* sprite, float x, float y, float width, float height, const Vec4& color, float angle = 0.0f, float pivotX = 0.0f, float pivotY = 0.0f);
